...
public class StatementController {
	 ...
	 * @param activity
	 *            the activity
	 * @return JSON string of the statement objects matching the specified
	 *         filter
	 */
	@RequestMapping(method = RequestMethod.GET, produces = "application/json;charset=utf-8", params = "!statementId")
	public StatementResult getStatement(
		...
		try {
			Map<String, String> filterMap = StatementUtils
					.createStatementFilterMap(actor, activity, since, until,
							limit);
