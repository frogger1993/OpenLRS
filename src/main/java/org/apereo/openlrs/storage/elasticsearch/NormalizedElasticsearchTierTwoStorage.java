...
public class NormalizedElasticsearchTierTwoStorage implements
	...
	public List<OpenLRSEntity> saveAll(Collection<OpenLRSEntity> entities) {
		...
		if (entities != null && !entities.isEmpty()) {
			...
			retval = (List<OpenLRSEntity>) (List<?>) elasticsearchEventRepository
					.save(events);
	...
	public Page<OpenLRSEntity> findAll(Pageable pageable) {
		return (Page<OpenLRSEntity>) (Page<?>) elasticsearchEventRepository
				.findAll(pageable);
	}
	...
	public List<OpenLRSEntity> findAll() {
		...
		return (List<OpenLRSEntity>) (List<?>) IteratorUtils.toList(events
				.iterator());
	}
