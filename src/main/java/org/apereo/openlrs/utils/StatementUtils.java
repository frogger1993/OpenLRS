...
public class StatementUtils {
	...
	/**
	 * Verifies the statement has all required properties: Actor Verb Object
	 * 
	 * @param propertyMap
	 *            the map containing the statement properties
	...
	public static boolean hasAllRequiredProperties(String jsonProperties) {
		...
		Map<String, Object> propertyMap = JsonUtils
				.parseJsonStringToMap(jsonProperties);
	...
	public static boolean hasAllRequiredProperties(
		...
		Map<String, String> actorMap = (Map<String, String>) propertyMap
				.get("actor");
		...
		Map<String, String> verbMap = (Map<String, String>) propertyMap
				.get("verb");
		...
		Map<String, String> objectMap = (Map<String, String>) propertyMap
				.get("object");
	...
	/**
	 * Creates a map of the statement filter criteria. If a value is not set, it
	 ...
	 */
	public static Map<String, String> createStatementFilterMap(String actor,
			String activity, String since, String until, String limit) {
