...
public class LaunchRequest extends LtiMessage {
	...
	public LaunchRequest(
		...
		super(lti_message_type, lti_version, oauth_consumer_key,
				oauth_signature_method, oauth_timestamp, oauth_nonce,
				oauth_version, oauth_signature, oauth_callback);
	...
	public SortedMap<String, String> toSortedMap() {
		...
		if (lis_person_contact_email_primary != null) {
			sm.put("lis_person_contact_email_primary",
		...
		if (launch_presentation_document_target != null) {
			sm.put("launch_presentation_document_target",
		...
		if (launch_presentation_return_url != null) {
			sm.put("launch_presentation_return_url",
					launch_presentation_return_url);
		}
		if (tool_consumer_info_product_family_code != null) {
			sm.put("tool_consumer_info_product_family_code",
		...
		if (tool_consumer_instance_description != null) {
			sm.put("tool_consumer_instance_description",
		...
		if (tool_consumer_instance_contact_email != null) {
			sm.put("tool_consumer_instance_contact_email",
	...
	private void init(Map<String, String> paramMap) {
		...
		this.resource_link_description = paramMap
				.get("resource_link_description");
		...
		this.lis_person_contact_email_primary = paramMap
				.get("lis_person_contact_email_primary");
		...
		this.launch_presentation_locale = paramMap
				.get("launch_presentation_locale");
		this.launch_presentation_document_target = paramMap
				.get("launch_presentation_document_target");
		this.launch_presentation_css_url = paramMap
				.get("launch_presentation_css_url");
		this.launch_presentation_width = paramMap
				.get("launch_presentation_width");
		this.launch_presentation_width = paramMap
				.get("launch_presentation_width");
		this.launch_presentation_return_url = paramMap
				.get("launch_presentation_return_url");
		this.tool_consumer_info_product_family_code = paramMap
				.get("tool_consumer_info_product_family_code");
		this.tool_consumer_info_version = paramMap
				.get("tool_consumer_info_version");
		this.tool_consumer_instance_guid = paramMap
				.get("tool_consumer_instance_guid");
		this.tool_consumer_instance_name = paramMap
				.get("tool_consumer_instance_name");
		this.tool_consumer_instance_description = paramMap
				.get("tool_consumer_instance_description");
		this.tool_consumer_instance_url = paramMap
				.get("tool_consumer_instance_url");
		this.tool_consumer_instance_contact_email = paramMap
				.get("tool_consumer_instance_contact_email");
			...
			if (keys != null && !keys.isEmpty()) {
				for (String key : keys) {
					if (key != null && key.startsWith("custom_")) {
						...
						// unknown type that we didn't account for. We still
						// need
	...
	public void setLaunch_presentation_document_target(
			String launch_presentation_document_target) {
		this.launch_presentation_document_target = launch_presentation_document_target;
	}
	...
	public void setLaunch_presentation_return_url(
	...
	public void setLaunch_presentation_css_url(
			String launch_presentation_css_url) {
		this.launch_presentation_css_url = launch_presentation_css_url;
	}
	...
	public void setLis_person_contact_email_primary(
	...
	public void setTool_consumer_info_product_family_code(
	...
	public void setTool_consumer_instance_guid(
			String tool_consumer_instance_guid) {
		this.tool_consumer_instance_guid = tool_consumer_instance_guid;
	}

	public void setTool_consumer_instance_name(
			String tool_consumer_instance_name) {
		this.tool_consumer_instance_name = tool_consumer_instance_name;
	}

	public void setTool_consumer_instance_description(
	...
	public void setTool_consumer_instance_contact_email(
